...
export default function Hero() {
  ...
  return (
    <section
      id="home"
      className="min-h-screen py-10 lg:h-[calc(100vh-7rem)] flex items-center justify-center flex-col lg:py-0 px-5 gap-10 lg:flex-row lg:justify-between lg:px-40 lg:gap-0"
    >
